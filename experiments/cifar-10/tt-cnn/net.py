...
opts['inp_modes_1'] = np.array([IMAGE_SIZE, IMAGE_SIZE,IN_CHANNELS], dtype='int32') 
opts['out_modes_1'] = np.array([IMAGE_SIZE, IMAGE_SIZE,OUT_CHANNELS], dtype='int32') 

opts['filter_modes_1'] = np.array([FILTER_SIZE, FILTER_SIZE, IN_CHANNELS, OUT_CHANNELS], dtype='int32')
opts['ranks_1'] = np.array([1, 3, 3, 3, 1], dtype='int32') 

opts['inp_modes_2'] = opts['out_modes_1']
opts['out_modes_2'] = np.array([IMAGE_SIZE, IMAGE_SIZE,OUT_CHANNELS], dtype='int32')
#opts['out_modes_2'] = np.array([4, 4, 4, 4, 4, 4], dtype='int32')
opts['filter_modes_2'] = np.array([FILTER_SIZE, FILTER_SIZE, OUT_CHANNELS, OUT_CHANNELS], dtype='int32')
...
def inference(images, train_phase):
    ...
    layers = []
    images = tf.reshape(images, shape=[-1,IMAGE_SIZE, IMAGE_SIZE,IN_CHANNELS])

    layers.append(images)    

    
    layers.append(tensornet.layers.tt_cnn(layers[-1],
                                     opts['inp_modes_1'],
                                     opts['out_modes_1'],
                                     opts['filter_modes_1'],
                                     opts['ranks_1'],
...
##########################################
    conv2 = layers[-1]
    conv2 = tf.reshape(conv2, [-1, np.prod(opts['out_modes_2'])])
    layers.append(tensornet.layers.linear(conv2,                                          
