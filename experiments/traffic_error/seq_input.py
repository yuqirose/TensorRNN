...
import pandas as pd
import os
def seq_raw_data(data_path='/home/roseyu/LA_Traffic/', val_size = 0.1, test_size = 0.1):
    """load from data_path the data [time, feature]"""
