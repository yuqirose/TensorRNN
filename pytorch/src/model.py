...
class Seq_RNN(nn.Module):
    ...
    """Sequence model module with vanilla RNN
    
    Attributes:
        lstm1 (TYPE): Description
        lstm2 (TYPE): Description
    """
...
class Seq_TRNN(nn.Module):

    """Sequence model module with tensor recurrent neural network (TRNN)
